"""
Reglas de negocio de la PoC.

Este módulo es **Python puro**: no importa Django ni toca archivos. Esa es
justamente la apuesta de la Prueba de Concepto — demostrar que las reglas
críticas del arriendo son correctas y verificables de forma aislada, antes de
construir el modelo relacional del MVP.
